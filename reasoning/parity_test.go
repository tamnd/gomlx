...
// TestReasoningParity replays golden fixtures captured from the Rapid-MLX
// Python reference (testdata/parity/reasoning/gen_fixtures.py) and asserts the
// Go ports produce identical reasoning/content splits for both the full
// extraction and the chunk-by-chunk streaming path.
